...
from ..serializers import RequirementSerializer, ServiceListSerializer


# Services can only be listed and created via a project?
# They also cannot be updated via the API
class ServiceListViewSet(mixins.RetrieveModelMixin,
                         mixins.DestroyModelMixin,
                         viewsets.GenericViewSet):
    """
    View set for the service list using the service model.
    """
...
class ServiceListRequirementsViewSet(mixins.ListModelMixin,
