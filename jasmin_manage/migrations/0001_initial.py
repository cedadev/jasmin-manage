# Generated by Django 3.0.2 on 2020-01-29 14:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_consortium', models.ForeignKey(help_text='Default consortium for requirements in the project, if known.<br />Can be overridden on a per-requirement basis.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='jasmin_manage.Consortium')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('consortium', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requirements', related_query_name='requirement', to='jasmin_manage.Consortium')),
