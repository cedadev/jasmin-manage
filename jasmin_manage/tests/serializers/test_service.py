...
class ServiceSerializerTestCase(TestCase):
    ...
    def test_renders_instance_correctly(self):
        ...
        self.assertCountEqual(serializer.data.keys(), {'id', 'name', 'category', 'project', '_links'})
    ...
    def test_cannot_override_project_on_create(self):
        ...
        self.assertEqual(len(project.services.all()), 0) # This project should have no services
