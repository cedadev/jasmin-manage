...
class QuotaModelTestCase(AssertValidationErrorsMixin, TestCase):
    ...
    def test_unique_together(self):
        ...
        new_quota = Quota(consortium = quota.consortium, resource = quota.resource, amount = 20)
    ...
    def test_annotate_usage(self):
        ...
        for i in range(2000):
            ...
            consortium_status = resource_status.setdefault(service.project.consortium.pk, {})
            requirement_status = consortium_status.setdefault(status, { 'count': 0, 'total': 0 })
